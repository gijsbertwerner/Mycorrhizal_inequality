...
In the third figure, we will visualise the movement of phosphorus inside the fungal network both from the rich to the poor compartment, and in the opposite direction. We will statistically analyse the net movement, i.e. the difference between flow in both directions. 
...
This shows that inequality is a highly signficant predictor of net phosphorus movement between the fungal networks in both compartments. 
...
As expected, this figures shows that in the plates without inequality, where both compartments are equal, net movement is close to zero. In both other conditions, there is net movement from the fungal network in the rich compartment to the poor compartment network. 
